...
const sistema1 = `Agirai come un bot whatsapp creato da Fabri115`;
...
handler.command = /^(openaivoce|chatgptvoce|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|ciambello|FabriBotvoce|gptvoz|ai_voz|ai_voce)$/i;
export default handler;

async function tts(text = 'error', lang = 'it') {

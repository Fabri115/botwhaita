...
const isLink1 = /([A-Za-z]{1,40}).com\/([0-9A-Za-z]{3,40})/i
const isLink2 = /([A-Za-z]{1,40}).it\/([0-9A-Za-z]{3,40})/i
const isLink3 = /([A-Za-z]{1,40}).be\/([0-9A-Za-z]{3,40})/i
const isLink4 = /([A-Za-z]{1,40}).me\/([0-9A-Za-z]{3,40})/i
const isLink5 = /([A-Za-z]{1,40}).net\/([0-9A-Za-z]{3,40})/i
